...
@php $homeData = \App\Models\HomeSection::singleton(); @endphp
  ...
  {{-- CONTENT --}}
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-24 lg:py-32 grid grid-cols-1 items-center">
    ...
    <div class="max-w-4xl mx-auto text-center">
      ...
      <p class="text-gray-500 text-lg leading-relaxed mb-8 max-w-3xl mx-auto text-center">
        {{ $homeData->description }}
      </p>

      <div class="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-4 relative z-[60]">
