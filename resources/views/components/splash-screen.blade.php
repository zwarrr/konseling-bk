	...
	<div class="relative flex flex-col items-center gap-5 splash-content">
		...
		<div class="relative flex items-center justify-center">
			...
			<div class="relative z-10 w-24 h-24 flex items-center justify-center splash-icon-box">
				<img src="/assets/img/app-icon.png" alt="E-Konseling" class="w-24 h-24 rounded-[28px] object-contain shadow-lg">
				{{-- Notification dot --}}
...
<style>
	/* Hide splash in installed PWA (standalone) so it goes straight to onboarding/content. */
...
<script>
	(function () {
		...
		// In installed PWA: no splash overlay.
		if (isStandalonePwa()) {
